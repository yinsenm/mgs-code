"""
Name     : nearest_correlation.py
Author   : William Smyth/Yinsen Miao
Contact : drwss.academy@gmail.com/yinsenm@gmail.com
Time     : 1/12/2022
Desc     : implement Higham's alternating projections algorithm
"""
...
def nearcorr(A, tol=[], flag=0, max_iterations=5000, n_pos_eig=0,
    ...
    if not tol:
        tol = np.sqrt(eps)*np.shape(A)[0]*np.array([1, 1])
    if weights is None:
